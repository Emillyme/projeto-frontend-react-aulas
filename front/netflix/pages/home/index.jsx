...
export default function Home() {
    ...
    const capturar = async () => {
        try {
            ...
            const responseClassif = await axios.get(
                'http://127.0.0.1:8000/api/genero/' + response.data.classif, {
                    headers:{
                        Authorization: `Bearer ${token}`
                    }
                }
            ...
            setGeneroG(responseGenre.data.genre)
            setAnoG(response.data.ano)
            setClassifG(responseClassif.data.classif)
